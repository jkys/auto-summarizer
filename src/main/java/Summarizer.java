 ...
 * Class Summarizer is used as the start point for the project and create all necessary objects and method calls on
 * those objects to compete the goal.
 */
...
//    outputStream.close();
  ...
  private static Stack<String> createStopWords(String path) throws FileNotFoundException {
    ...
    Scanner stopWordList = new Scanner(new FileReader
        (path));
   ...
   */
  private static Hashtable<String, Double> findWordOccurrences(List<String> articleWords, List<String> stopWords, int inverse) {
   ...
   * @param mergedObject Json object containing all words as keys with their values being the amount of occurrences of that
   * word.
   * @return Json object containing each sentence as keys with their values being the amount of occurrences of words
   * in the sentence.
   */
  private static Hashtable<String, Double> findWordInSentenceOccurrences(List<String> articleSentences, Hashtable<String, Double> mergedObject) {
